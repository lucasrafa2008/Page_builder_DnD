    ...
    return (
        <div>
            <Board id="board-1" className="board">
                                <Card id="card-2" draggable="true" className="card">
                                    {/* AREA CHART */}
                                    ...
                                    <Card id="card-3" draggable="true" className="card">
                                    {/* DONUT CHART */}
                                    ...
                                    <Card id="card-4" draggable="true" className="card">
                                    {/* PIE CHART */}
                                    <div className="card card-danger">
                                    <div className="card-header">
                                    ...
                                    <div className="card-body">
                                     ...
                                     <Card id="card-5" draggable="true" className="card">
                                        {/* LINE CHART */}
                                    ...
                                    <Card id="card-6" draggable="true" className="card">
                                        {/* BAR CHART */}
                                    ...
                                    <Card id="card-7" draggable="true" className="card">
                                    {/* STACKED BAR CHART */}
                                    <div className="card card-success">
                                    <div className="card-header">
